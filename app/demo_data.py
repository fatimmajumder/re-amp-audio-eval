...
SCENARIO_LIBRARY = [
    ...
    BenchmarkScenario(
        name="adversarial_prompt_perturbation",
        difficulty="hard",
        category="prompting",
        description="Measures how small prompt rewrites or injected instructions shift output quality.",
        tags=["prompt-injection", "red-team", "prompt-robustness"],
        weight=1.25,
    ),
    BenchmarkScenario(
        name="multilingual_prompt_shift",
        difficulty="hard",
        category="linguistic",
        description="Validates instruction following when prompts mix English with other languages.",
        tags=["multilingual", "localization", "instruction-following"],
        weight=1.15,
    ),
    BenchmarkScenario(
        name="speaker_transfer_failure",
        difficulty="hard",
        category="identity",
        description="Stress test for speaker consistency under transfer, style interpolation, and accent drift.",
        tags=["speaker-transfer", "identity", "accent"],
        weight=1.2,
    ),
]
...
BENCHMARK_TEMPLATES = [
    BenchmarkTemplate(
        ...
        default_scenarios=[
            ...
            "codec_degradation",
            "tempo_variation",
            "adversarial_prompt_perturbation",
        ],
    ...
    BenchmarkTemplate(
        ...
        default_scenarios=[
            ...
            "tempo_variation",
            "microphone_distance",
            "multilingual_prompt_shift",
            "speaker_transfer_failure",
        ],
...
def build_seed_workspaces() -> list[WorkspaceRecord]:
    return [
        WorkspaceRecord(
            ...
            tenant_name="Arthur Labs",
            tenant_slug="arthur-labs",
            project_name="Core Eval Platform",
            project_slug="core-eval-platform",
            ...
            default_prompt_schema="prompt-schema-2026-04",
            default_judge_configuration="aurora-judge-v4",
        ),
        WorkspaceRecord(
            ...
            tenant_name="Arthur Labs",
            tenant_slug="arthur-labs",
            project_name="Music Quality Initiative",
            project_slug="music-quality-initiative",
            ...
            default_prompt_schema="mix-schema-2026-03",
            default_judge_configuration="aurora-judge-v4",
        ),
        WorkspaceRecord(
            ...
            tenant_name="Arthur Labs",
            tenant_slug="arthur-labs",
            project_name="Speech Red Team",
            project_slug="speech-red-team",
            focus_areas=["speaker overlap", "noisy speech", "keyword failures", "prompt injection"],
            ...
            default_prompt_schema="speech-redteam-schema-2026-04",
            default_judge_configuration="safety-audio-judge-v2",
        ),
    ]
